<?php # -*- coding: utf-8 -*-
/**
 * Plugin Name: WenArgon-Emoji-BiliBili
...
function dashboard_submenu() {
    add_dashboard_page(__('仪表盘设置'), __('WenArgon-Emoji设置'), 'read', 'your-unique-identifier', 'add_dashboard_submenu');
}
function add_dashboard_submenu() {
  echo '<div><p><h1><strong>WenArgon-Emoji-BiliBili</strong></h1></p></div>';
  echo '<div><p>版本23.6.16&nbsp;&nbsp;&nbsp;<a href="https://github.com/Andy17269/wen-argon-theme-emoji">检查更新</a></p></div>';
  echo '<div><p><a href="https://wenlei.club">作者博客</a>&nbsp;&nbsp;<a href="https://space.bilibili.com/1272602094">B站</a></p></div>';
  echo '<div><p>支持我的开发，就到<a href="https://github.com/Andy17269/wen-argon-theme-emoji">Github</a>里点颗Star⭐吧！</p></div>';
}
?>